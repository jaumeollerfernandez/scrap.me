...
listaURLTAGS=[]
lista = []
capta = Captador(True) # instancia de la clase
trat = TratoFicheros("baseDatos.txt")


capta.introducirURL(lista)
listaEmpresa = capta.extraerNombres(lista)
listaURLTAGS = capta.setTags(trat,listaEmpresa, lista, listaURLTAGS)
tratList = TratoFicheros("url_tag.txt", listaURLTAGS)
