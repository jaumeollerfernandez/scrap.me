...
class Mainwindow(object):
    def setupUi(self, Main_window):
        ...
        self.insert_btn.setGeometry(QRect(590, 370, 101, 41))
...
"")
        self.delete_btn = QPushButton(self.content_frame)
        self.delete_btn.setObjectName(u"delete_btn")
        self.delete_btn.setGeometry(QRect(590, 420, 101, 41))
        self.delete_btn.setStyleSheet(u"background-color:red;\n"
"color:white")
    ...
    def retranslateUi(self, Main_window):
        ...
        self.delete_btn.setText(QCoreApplication.translate("Main_window", u"DELETE", None))
    # retranslateUi
