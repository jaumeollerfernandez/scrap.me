...
class MainWindowInterface(object):
    def setupUi(self, MainWindow):
        ...
        self.sleep_button.setGeometry(QRect(24, 420, 111, 23))
        self.producto_name = QGroupBox(self.centralwidget)
        self.producto_name.setObjectName(u"producto_name")
        self.producto_name.setGeometry(QRect(85, 30, 61, 16))
        self.producto_name.setAlignment(Qt.AlignCenter)
        self.precio_name = QGroupBox(self.centralwidget)
        self.precio_name.setObjectName(u"precio_name")
        self.precio_name.setEnabled(True)
        self.precio_name.setGeometry(QRect(295, 30, 81, 21))
        self.precio_name.setAlignment(Qt.AlignCenter)
        self.precio_name.setFlat(False)
        self.url_name = QGroupBox(self.centralwidget)
        self.url_name.setObjectName(u"url_name")
        self.url_name.setGeometry(QRect(570, 30, 31, 16))
        ...
        self.alerta_name.setGeometry(QRect(805, 30, 51, 16))
        ...
        self.spinBox.setGeometry(QRect(150, 420, 131, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sleep_button.setText(QCoreApplication.translate("MainWindow", u"Tiempo (segundos)", None))
